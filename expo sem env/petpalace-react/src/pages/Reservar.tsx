...
const Reservar: React.FC = () => {
  const [showOtherPetType, setShowOtherPetType] = useState(false);
    ...
    <div className="reservar-page">
      ...
      <section className="reserva-section">
        <div className="reserva-header">
          <h2>Escolha o hotel ideal para seu pet</h2>
          <p className="intro">Veja opções incríveis, com amor e conforto para seu companheiro.</p>
        </div>
